**ChatApp** is a real-time chat application that allows users to communicate with each other instantly. It provides a platform for users to exchange messages in individual or group chats.
